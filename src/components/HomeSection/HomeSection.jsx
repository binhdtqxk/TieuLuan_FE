...
const HomeSection = () => {
  ...
  return (
    <div className="space-y-5">
      <section>
        <h1 className="!text-xl font-bold opacity-90" style={{ fontSize: "1.5rem" }}>
          Home
        </h1>
      </section>
      <section className={`pb-10`}>
        <div className="flex space-x-5">
          <Avatar alt="username" src="https://pbs.twimg.com/profile_images/1843591782317338628/pGgFUDI9_400x400.png" />
